...
// WIN32 PATCH: #include <netinet/in.h> covered by win_compat.h
// WIN32 PATCH: #include <netinet/tcp.h> covered by win_compat.h
// WIN32 PATCH: #include <sys/socket.h> covered by win_compat.h
...
Socket::Socket(int port) {
  ...
  setsockopt(_sock, SOL_SOCKET, SO_REUSEADDR, (const char*)&y, sizeof(y));
  setsockopt(_sock, SOL_SOCKET, SO_REUSEADDR, (const char*)&y, sizeof(y));
...
void HttpServer::send(int sock, Answer* aw) {
  // ignore SIGPIPE
  #ifndef _WIN32  // WIN32 PATCH: no SIGPIPE on Windows
